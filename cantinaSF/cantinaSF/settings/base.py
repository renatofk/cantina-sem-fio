"""
Django settings for cantinaSF project.
...
WSGI_APPLICATION = "cantinaSF.wsgi.application"
...
STATIC_ROOT = os.path.join(BASE_DIR, "static")  # Pasta final gerada pelo collectstatic
STATIC_URL = "/static/"
